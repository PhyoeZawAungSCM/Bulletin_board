          ...
          <ValidationObserver v-slot="{ handleSubmit }">
            <form @submit.prevent="
              ...
              <div class="row mb-3 align-items-center">
                ...
                <div class="col-8">
                  <ValidationProvider name="Password" rules="required|min:6|max:50" v-slot="{ errors }"
                    vid="passwordConfirm">
              ...
              <div class="row mb-3 align-items-center">
                ...
                <div class="col-8">
                  <ValidationProvider name="Password confirmation" rules="required|min:6|max:50|confirm:passwordConfirm"
                    v-slot="{ errors }">
                    <input type="password" class="form-control" id="passwordConfirm" v-model="user.confirmPassword" />
                    <span class="invalid-feedback">{{
                      errors[0]
                    }}</span>
                  </ValidationProvider>
              ...
              <div class="row mb-3 align-items-center">
                ...
                <div class="col-8">
                  ...
                  <div class="mb-3" v-else>
                    <ValidationProvider name="Profile" rules="required|image|size:2048" ref="provider"
                      v-slot="{ errors }">
              ...
              <!-- profile input -->
              <div v-if="isConfirm" class="row justify-content-end">
                <div class="col-8">
